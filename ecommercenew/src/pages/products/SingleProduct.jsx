            ...
            <div className="spdetailsdiv">
                ...
                <div className="spbuttons">
                    <div className="spquantity">
                        <button className="spquantitydecbtn" onClick={() => { setQuantity(q => q - 1) }} disabled={quantity <= 1}>
                            -
                        </button>
                        <p className="spquantitytxt">Quantity : {quantity}</p>
                        <button className="spquantityincbtn" onClick={() => { setQuantity(q => q + 1) }}>
                            +
                        </button>
                    </div>
